...
public class Student extends data.User implements iMenu {
    ...
    public static class UserStudent {
        private final String ultrafast;
        public String name;
    ...
    public boolean isStudents(TextField username) throws IllegalAdminAcsess {
        if (username.getText().length() != 15) {
            throw new IllegalAdminAcsess("NIM harus 15 digit!");
        }
        ...
        throw new IllegalAdminAcsess("NIM tidak ditemukan!");
    }

    public class IllegalAdminAcsess extends Throwable {
        public IllegalAdminAcsess(String string) {
        }
    }
}